...
!  use the Fortran convention of 1-based indices (rather 0-based indices).
      ...
      ! Yi: test 
      print *,'rank =', rank, 'xs',xs, 'xe', xe
      print *,'rank =', rank, 'ys', ys, 'ye', ye
      print *,'rank =', rank, 'gys', gys, 'gye', gye

      print *,'const da info xs = ', DMDA_LOCAL_INFO_XS
      print *,'const da info xm = ', DMDA_LOCAL_INFO_XM
      print *,'const da info ys = ', DMDA_LOCAL_INFO_YS
      print *,'const da info ye = ', DMDA_LOCAL_INFO_YM
      print *,'const da info mx = ', DMDA_LOCAL_INFO_MX
      print *,'const da info my = ', DMDA_LOCAL_INFO_MY
...
!  Local variables:
      ...
      ! Yi: this is already done in main?
      xs     = info(DMDA_LOCAL_INFO_XS)+1
      xe     = xs+info(DMDA_LOCAL_INFO_XM)-1
      ys     = info(DMDA_LOCAL_INFO_YS)+1
      ye     = ys+info(DMDA_LOCAL_INFO_YM)-1
